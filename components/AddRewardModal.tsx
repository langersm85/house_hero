...
interface AddRewardModalProps {
  visible: boolean;
  onClose: () => void;
  onAdd: (name: string, pointsRequired: number, type: Reward['type'], description?: string) => void;
}

export function AddRewardModal({ visible, onClose, onAdd }: AddRewardModalProps) {
  ...
  const handleAdd = () => {
    if (name.trim() && pointsRequired.trim()) {
      onAdd(name.trim(), parseInt(pointsRequired), selectedType, description.trim() || undefined);
      setName('');
      setPointsRequired('');
      setDescription('');
      ...
      <View style={styles.modalOverlay}>
        <View style={styles.modalContent}>
          ...
          <View style={styles.buttonContainer}>
            ...
            <TouchableOpacity
              style={[styles.button, styles.addButton, (!name.trim() || !pointsRequired.trim()) && styles.disabledButton]}
              onPress={handleAdd}
